...
```txt
HTTP Gin     : :8083 /payment, /health, /metrics
gRPC server  : :9093 kazakhexpress.payment.v1.PaymentService
gRPC client  : smtp-service:9094 kazakhexpress.smtp.v1.SMTPService
...
proto                     public gRPC contract reference
```
