...
- HTTP: Gin adapter остается внутри сервиса; наружу payment идет через API Gateway.
...
- Observability: Grafana with PostgreSQL 17 datasource.
...
В docker-compose наружу открыт только API Gateway:
