...
type ReviewServiceClient interface {
	...
	GetProductRating(ctx context.Context, in *GetProductRatingRequest, opts ...grpc.CallOption) (*ProductRating, error)
}
...
func (c *reviewServiceClient) CreateReview(ctx context.Context, in *CreateReviewRequest, opts ...grpc.CallOption) (*Review, error) {
	out := new(Review)
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/CreateReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) GetReview(ctx context.Context, in *GetReviewRequest, opts ...grpc.CallOption) (*Review, error) {
	out := new(Review)
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/GetReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) ListProductReviews(ctx context.Context, in *ListProductReviewsRequest, opts ...grpc.CallOption) (*ListProductReviewsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/ListProductReviews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) UpdateReview(ctx context.Context, in *UpdateReviewRequest, opts ...grpc.CallOption) (*Review, error) {
	out := new(Review)
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/UpdateReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) DeleteReview(ctx context.Context, in *DeleteReviewRequest, opts ...grpc.CallOption) (*DeleteReviewResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/DeleteReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) GetProductRating(ctx context.Context, in *GetProductRatingRequest, opts ...grpc.CallOption) (*ProductRating, error) {
	out := new(ProductRating)
	err := c.cc.Invoke(ctx, "/kazakhexpress.review.v1.ReviewService/GetProductRating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServiceServer interface {
	...
	GetProductRating(context.Context, *GetProductRatingRequest) (*ProductRating, error)
}
...
func (UnimplementedReviewServiceServer) GetProductRating(context.Context, *GetProductRatingRequest) (*ProductRating, error) {
...
func _ReviewService_CreateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/CreateReview",
	}
...
func _ReviewService_GetReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/GetReview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReviewService_ListProductReviews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/ListProductReviews",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReviewService_UpdateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/UpdateReview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReviewService_DeleteReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/DeleteReview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReviewService_GetProductRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazakhexpress.review.v1.ReviewService/GetProductRating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kazakhexpress.review.v1.ReviewService",
